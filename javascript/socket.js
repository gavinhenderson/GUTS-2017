...
myRoom.on('getPlayerID', function(playerID) {
    ...
    gameID = playerID;
		...
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1270, 245], [1140, 245]],48)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1275, 225], [1140, 225]],49)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1280, 205], [1140, 205]],50)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1280, 245, 20, 20, poly, [[1245, 185], [1140, 185]],51)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1270, 165], [1140, 165]],52)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1275, 145], [1140, 145]],53)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1280, 125], [1140, 125]],54)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1280, 245, 20, 20, poly, [[1245, 105], [1140, 105]],55)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1270, 85], [1140, 85]],56)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1275, 65], [1140, 65]],57)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1245, 245, 20, 20, poly, [[1280, 45], [1140, 45]],58)); // ---------------- DOOR 10 - [1245, 285]
		Guards.push(new Guard(1280, 245, 20, 20, poly, [[1245, 25], [1140, 25]],59)); // ---------------- DOOR 10 - [1245, 285]
